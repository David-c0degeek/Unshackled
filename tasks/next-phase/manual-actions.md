...
|---|---|---|---|---|---|
| 02.8 | product-owner | Review and approve the reliability-contract ADR and the bypass-scope decision (02.5) | 02 | TODO | |
...
| 04.2 | product-owner | Sign off models.dev license/attribution and the vendoring approach before the snapshot lands in-repo | 04 | TODO | |
| M1 | product-owner | §8 acceptance sign-off after the §7 gate passes | plan | TODO | |
| M2 | product-owner | `review-technical.2026-06-09.md` and `review.2026-06-09.md` are untracked at the repo root; commit them (suggested: move under `tasks/`) so the plan's authoritative inputs are durable across machines and resets | plan | TODO | |
