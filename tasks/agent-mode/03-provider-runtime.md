...
- [ ] **03.1** (agent) Honor the documented public provider env vars as a config
...
- [ ] **03.2** (agent) Result: an external launcher that exports those env vars
...
- [ ] **03.3** (agent) Add a configurable request timeout suited to slow local
...
- [ ] **03.4** (agent) Handle reasoning/thinking robustly: strip or route inline
...
- [ ] **03.5** (agent) Provide a documented way to suppress model thinking where
