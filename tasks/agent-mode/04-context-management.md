...
- [ ] **04.1** (agent) Tune compaction so it preserves the task goal, the most
...
- [ ] **04.2** (agent) Add an original conversation-summary step that condenses
...
- [ ] **04.3** (agent) Estimate and surface context usage accurately in the
...
- [ ] **04.4** (agent) Verify behavior at the boundary: a session that exceeds
