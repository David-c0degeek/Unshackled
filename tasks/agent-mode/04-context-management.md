...
- 2026-06-03 · post-close hardening · 04.1 · read-only behavior-reference commit review identified a context-cut edge case: final budget trimming must not split a kept tool call/result round · fixed with whole-exchange final trimming and adaptive summaries · verified with compaction regression tests.
