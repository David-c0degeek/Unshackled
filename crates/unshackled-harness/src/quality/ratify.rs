...
//! never runs until it is written into committed `.unshackled.toml`. This module
...
use unshackled_sandbox::CommandClass;
...
pub struct GateRatification {
    ...
    /// The full new `.unshackled.toml` text. Equals the input when nothing is
